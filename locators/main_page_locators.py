...
class MainPageLocators:
    ...
    ROUTE_PINS = (
        By.XPATH,
        ".//ymaps[contains(@class,'ymaps-2-1-79-route-pin_state_expanded')]")
    ...
    BUTTON_CALL_TAXI = (
        By.XPATH,
        ".//button[contains(@class,'round') and text()='Вызвать такси']")
